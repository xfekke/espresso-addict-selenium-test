Feature: Game displays an image
  ...
  Scenario: Outside Cafe image
    ...
    When I do nothing
    Then I should I see an image of the cafe
    And I should see descriptive text explaining the scenario

  Scenario: Inside Cafe image
    Given that I am outside the "Cafe"
    When I click the "Enter the cafe" button
    Then I should I see an image displayed inside the cafe
    And I should see descriptive text explaining the scenario
